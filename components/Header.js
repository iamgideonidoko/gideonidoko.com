	...
	return (
		<header className="header">			
			<div className="logo-wrap">
				<Link href="/"><a><img src="/assets/img/GideonIdokoDevLogo.png" className="site-logo" alt="Gideon Idoko"/></a></Link>
			</div>
			<div className="nav-adminmenu-wrap">
			<div>
				<button onClick={handleNavMenuBtnClick} className="nav-menu-btn"><i className={!props.isNavOpen ? "neu-close-lg" : "neu-hamburger-menu"}></i></button>
			</div>
				...
				<Nav isNavOpen={props.isNavOpen} />
			{
				...
				props.auth.isAuthenticated && <AdminMenu adminUsername={props.auth.adminuser.username} isNavOpen={props.isNavOpen}  />
			}
			</div>
...
export default connect(mapStateToProps, { getPosts, loadAdminUser, getGithubUser, loadFirebase, getAssets, getContacts })(Header);