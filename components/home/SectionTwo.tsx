    ...
    () =>
      [
        ...
        },
        {
          ...
          cover1: '/assets/img/kanta-cover.png',
          cover2: '/assets/img/kanta-cover-hover.png',
          alt: 'Kanta cover',
          role: 'Full-stack Engineer',
          link1: 'https://kantaball.com',
          link1Text: 'View App',
          stack: ['TypeScript', 'Next.js', 'tRPC', 'Golang'],
        },
        {
          name: 'Dentbud',
    ...
    <div className={styles.sectionTwo}>
      <div className="container-full">
        <div className={styles.sec2Header}>
          ...
          <p>
            Here&apos;re some selected projects that showcase my passion for crafting memorable experiences and
            products:
          </p>
        </div>
              ...
              >
                ...
                <div className={styles.projectExtLinks}>
                  {project.link1 && (
                    ...
                    >
                      {project.link1Text ? project.link1Text : 'View Project'} <i className="neu-right-lg"></i>
                    </a>
                  )}
                  {project.link2 && (
                    <a
                    ...
                    >
                      {project.link2Text ? project.link2Text : 'View Code'} <i className="neu-right-lg"></i>
                    </a>
                  )}
                </div>
              </div>
