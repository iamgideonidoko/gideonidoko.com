        ...
        try {
          ...
          try {
            const mail = {
              ...
              text: `${commentAuthor.trim()} replied to a comment by ${currentComment?.comment_author} on your post, ${
                exactPost?.title
              }. <br /> The comment: ${
          ...
          <label>
            {isCommenting ? (
              <span>
                ...
                <b>{currentPostTitle.length > 25 ? `${currentPostTitle.substr(0, 25) + '...'}` : currentPostTitle}</b>
              </span>
            ) : (
              <span>
                You&apos;re replying to:{' '}
                <b>
                  {currentPostComments.find((comment) => comment._id === currentCommentId)
                    ? currentPostComments.find((comment) => comment._id === currentCommentId)?.comment_author
                    : null}
                </b>
              </span>
            )}
