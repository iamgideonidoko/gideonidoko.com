	...
	return (
		<Fragment>
			...
			<Head>
				...
				<meta name="keywords" content="gideon idoko,about gideon idoko,gideon, about gideon, about idoko,idoko,software developer,technical writer,software engineer,developer,engineer,writer"></meta>
			</Head>
			<main className={`padding-top-10rem ${styles.aboutMain}`}>
				<div className="container-max-1248px">
					...
					<p><b>No idea of what you really want?</b> I’ll assist you come up with a strategic plan which will help your business seamlessly grow.</p>

					<p><b>Want to chat about my content?</b> I’d be happy to engage in a discussion with you.</p>

					<p><b>Want your idea to be a reality?</b> I’ll pay close attention to what your idea is and aim to achieve and with suggestions, will create the best possible product as envisioned.</p>

					<p><b>Need more hands in your team?</b> I've got pliability and I can work with any team, even if they’re part way through a project. Just hit me up when you need me.</p>
