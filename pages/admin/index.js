					...
					<div className={styles.adminProfileWrap}>
						<div className={styles.profileHead}>
							...
							<div className={styles.statInfo}>
								...
								<tbody>
									<tr>
										<td><span>Posts: {props.post.posts.filter(post => post.author_username === props.adminuser.username).length}</span></td>	
										<td><span>Published Posts: {props.post.posts.filter(post => post.author_username === props.adminuser.username && post.is_published === true).length}</span></td>
										<td><span>Pinned Posts: {props.post.posts.filter(post => post.author_username === props.adminuser.username && post.is_pinned === true).length}</span></td>
									</tr>
								</tbody>
								</table>
							</div>
						<div className={styles.profileBody}>
							<div className={styles.actionLinks}>
								<ul>
									<li><Link href="/admin/create-post"><a>Create Post</a></Link></li>
									<li><Link href="/admin/manage-post"><a>Manage Post</a></Link></li>
