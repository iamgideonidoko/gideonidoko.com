...
2. #### deleteProperty()
   ...
   Reflect.deleteProperty(obj, 'two') ? console.log('property deleted!') : console.log('could not delete property'); // property deleted!
...
5. #### set()
   ...
   Reflect.set(obj, 'three', 3) ? console.log('property successfully set') : console.log('could not set property'); // "property successfully set"
